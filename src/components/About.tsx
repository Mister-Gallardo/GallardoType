  ...
  return (
    <div className='m-auto flex h-[90%] w-[90%] flex-col gap-7 py-10 font-mono text-lg'>
      <div className='flex flex-col gap-3'>
        <h1 className='text-3xl font-bold'>About GallardoType</h1>
        <p className=''>
          GallardoType is a minimalistic typing speed testing app built with React
      ...
      <div className=' mt-auto flex flex-col gap-1'>
        <div className='flex items-center gap-3'>
          ...
          ,
          <a
            href='https://api.whatsapp.com/send/?phone=%2B79882740532&text&type=phone_number&app_absent=0'
            target='_blank'
            className='hover:underline'
            rel='noopener noreferrer'
          >
